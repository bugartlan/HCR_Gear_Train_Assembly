...
def fixed_asset_pos_wrt_robot(
    ...
    fixed_asset_pos_w = fixed_asset.data.target_pos_w[:, 0, :]
    fixed_asset_quat_w = fixed_asset.data.target_quat_w[:, 0, :]
    fixed_asset_pos_b, _ = subtract_frame_transforms(
